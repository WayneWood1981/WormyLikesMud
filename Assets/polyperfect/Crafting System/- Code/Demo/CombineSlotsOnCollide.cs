...
namespace Polyperfect.Crafting.Demo
{
    ...
    public class CombineSlotsOnCollide : PolyMono
    {
        ...
        public override string __Usage => $"If stackable, causes the contents of the attached {nameof(BaseItemSlotComponent)} to merge with those it comes in contact with.\nOlder instantiations take priority.";
        public bool OtherNeedsCombineScript = true;
        
        void Awake() => _slot = GetComponent<BaseItemSlotComponent>();
