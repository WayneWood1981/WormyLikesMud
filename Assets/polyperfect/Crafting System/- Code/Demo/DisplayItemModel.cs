...
namespace Polyperfect.Crafting.Demo
{
    ...
    {
        public override string __Usage => "Creates a prefab based on the specified data for a given item, and sizes it so it fits within the given bounds. Connects to the attached BaseItemSlotComponent automatically.";
        ...
        void Awake()
        {
            ...
            slot.Changed += () => CreateAndDisplay(slot.Peek());
        }
